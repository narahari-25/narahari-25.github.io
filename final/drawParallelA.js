function drawParallelA(file1Data, file2Data, file3Data, file4Data) {
    ...
    PEA4 = PEA4 / 5;
    const data = [
        { letter: 'KRBL', Price_to_Earnings_ratio: PEA1, Price_to_Sales_ratio: SalesA1, EPS: EPSA1 },
        { letter: 'LT', Price_to_Earnings_ratio: PEA2, Price_to_Sales_ratio: SalesA2, EPS: EPSA2 },
        { letter: 'HM', Price_to_Earnings_ratio: PEA3, Price_to_Sales_ratio: SalesA3, EPS: EPSA3 },
        { letter: 'ADF', Price_to_Earnings_ratioe: PEA4, Price_to_Sales_ratio: SalesA4, EPS: EPSA4 }
    ];
...
svg.append("text")
    ...
    const KRBL = svg.selectAll(".KRBL-dot")
        ...
        .on("mouseover", function(event, d) {
            ...
            showTooltip(event, `KRBL: ${d.value}`);
        })
    ...
    const LT = svg.selectAll(".LT-dot")
        ...
        .on("mouseover", function(event, d) {
            // Show tooltip on mouseover
            showTooltip(event, `LT_Foods: ${d.value}`);
        })
        .on("mouseout", function() {
            // Hide tooltip on mouseout
            hideTooltip();
    ...
    const ADF = svg.selectAll(".ADF-dot")
    ...
    const lineKRBL12 = svg.append("line")
        .attr("class", "lineKRBL12")
    ...
    const lineKRBL23 = svg.append("line")
        .attr("class", "lineKRBL23")
        ...
        .attr("stroke-width", 2)
        .attr("opacity", 0.8);
    const lineLT12 = svg.append("line")
        .attr("class", "lineLT12")
        .attr("x1", xScale("Price_to_Earnings_ratio")) // Start x-coordinate
    ...
    const lineLT23 = svg.append("line")
        .attr("class", "lineLT23")
        .attr("x1", xScale("Price_to_Sales_ratio")) // Start x-coordinate
    ...
    const lineHM12 = svg.append("line")
        .attr("class", "lineHM12")
        .attr("x1", xScale("Price_to_Earnings_ratio")) // Start x-coordinate
    ...
    const lineHM23 = svg.append("line")
        .attr("class", "lineHM23")
        .attr("x1", xScale("Price_to_Sales_ratio")) // Start x-coordinate
    ...
    const lineADF12 = svg.append("line")
        .attr("class", "lineADF12")
        .attr("x1", xScale("Price_to_Earnings_ratio")) // Start x-coordinate
    ...
    const lineADF23 = svg.append("line")
        .attr("class", "lineADF23")
        .attr("x1", xScale("Price_to_Sales_ratio")) // Start x-coordinate
    ...
    legendItems.append("rect")
        ...
        .attr("fill", d => {
            switch (d) {
                case "KRBL": return "blue";
                case "LT": return "green";
                case "HM": return "purple";
                case "ADF": return "red";
