    ...
    return Promise.all([
            ...
            years1.forEach(year => {
                ...
                if (year.trim().length > 0) {
                    let yearData = {
                        ...
                        EPS:parseFloat(csvData1.find(row => row["Yearly Results of KRBL (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue:parseFloat(csvData1.find(row => row["Yearly Results of KRBL (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare:parseFloat(csvData1.find(row => row["Yearly Results of KRBL (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
            ...
            years2.forEach(year => {
                if (year.trim().length > 0) {
                    let yearData = {
                        ...
                        EPS: parseFloat(csvData2.find(row => row["Yearly Results of LT Foods (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData2.find(row => row["Yearly Results of LT Foods (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData2.find(row => row["Yearly Results of LT Foods (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
        ...
        d3.csv("food/Harrisons Malay_annual_results.csv").then(function (csvData3) {
            ...
            years3.forEach(year => {
                if (year.trim().length > 0) {
                    ...
                    let yearData = {
                        companyName: 'Harrisons Malayalam',
                        category: 'Food and Beverages',
                        year: year,
                        ...
                        EPS: parseFloat(csvData3.find(row => row["Yearly Results of Harrisons Malyalam (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData3.find(row => row["Yearly Results of Harrisons Malyalam (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData3.find(row => row["Yearly Results of Harrisons Malyalam (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
            ...
            years4.forEach(year => {
                if (year.trim().length > 0) {
                    let yearData = {
                        ...
                        EPS: parseFloat(csvData4.find(row => row["Yearly Results of ADF Foods Industries (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData4.find(row => row["Yearly Results of ADF Foods Industries (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData4.find(row => row["Yearly Results of ADF Foods Industries (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
        ...
        d3.csv("pharmaceuticals/HB_annual_results.csv").then(function (csvData5) {
            ...
            years5.forEach(year => {
                if (year.trim().length > 0) {
                    let yearData = {
                        companyName: 'Hester Biosciences',
                        ...
                        EPS: parseFloat(csvData5.find(row => row["Yearly Results of Hester Biosciences (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData5.find(row => row["Yearly Results of Hester Biosciences (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData5.find(row => row["Yearly Results of Hester Biosciences (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
            ...
            years6.forEach(year => {
                if (year.trim().length > 0) {
                    let yearData = {
                        ...
                        EPS: parseFloat(csvData6.find(row => row["Yearly Results of Kopran (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData6.find(row => row["Yearly Results of Kopran (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData6.find(row => row["Yearly Results of Kopran (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
            ...
            years7.forEach(year => {
                if (year.trim().length > 0) {
                    let yearData = {
                        ...
                        EPS: parseFloat(csvData7.find(row => row["Yearly Results of Themis Medicare (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData7.find(row => row["Yearly Results of Themis Medicare (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData7.find(row => row["Yearly Results of Themis Medicare (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
            ...
            years8.forEach(year => {
                if (year.trim().length > 0) {
                    let yearData = {
                        ...
                        EPS: parseFloat(csvData8.find(row => row["Yearly Results of Ind-Swift (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData8.find(row => row["Yearly Results of Ind-Swift (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData8.find(row => row["Yearly Results of Ind-Swift (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
        ...
        d3.csv("metalsAndMining/Godawari Power_annual_results.csv").then(function (csvData9) {
            ...
            years9.forEach(year => {
                if (year.trim().length > 0) {
                    let yearData = {
                        companyName: 'Godawari Power & Ispat',
                        ...
                        EPS: parseFloat(csvData9.find(row => row["Yearly Results of Godawari Power & Ispat (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData9.find(row => row["Yearly Results of Godawari Power & Ispat (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData9.find(row => row["Yearly Results of Godawari Power & Ispat (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
            ...
            years10.forEach(year => {
                if (year.trim().length > 0) {
                    let yearData = {
                        ...
                        EPS: parseFloat(csvData10.find(row => row["Yearly Results of Impex Ferro Tech (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData10.find(row => row["Yearly Results of Impex Ferro Tech (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData10.find(row => row["Yearly Results of Impex Ferro Tech (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
        ...
        d3.csv("metalsAndMining/Precision Wires_annual_results.csv").then(function (csvData11) {
            ...
            years11.forEach(year => {
                if (year.trim().length > 0) {
                    let yearData = {
                        companyName: 'Precision Wires India',
                        category: 'Metals and Mining',
                        year: year,
                        ...
                        EPS: parseFloat(csvData11.find(row => row["Yearly Results of Precision Wires India (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData11.find(row => row["Yearly Results of Precision Wires India (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData11.find(row => row["Yearly Results of Precision Wires India (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
        ...
        d3.csv("metalsAndMining/Technocraft Ind_annual_results.csv").then(function (csvData12) {
            ...
            years12.forEach(year => {
                if (year.trim().length > 0) {
                    let yearData = {
                        companyName: 'Technocraft Industries',
                        category: 'Metals and Mining',
                        year: year,
                        ...
                        EPS: parseFloat(csvData12.find(row => row["Yearly Results of Technocraft Industries (India) (in Rs. Cr.)"] === "Basic EPS (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        Revenue: parseFloat(csvData12.find(row => row["Yearly Results of Technocraft Industries (India) (in Rs. Cr.)"] === "Revenue from Operations/Share (Rs.)")[year].replace(/,/g, '').replace('(', '-').replace(')', '')),
                        SalesperShare: parseFloat(csvData12.find(row => row["Yearly Results of Technocraft Industries (India) (in Rs. Cr.)"] === "Price/Net Operating Revenue")[year].replace(/,/g, '').replace('(', '-').replace(')', ''))
                    };
