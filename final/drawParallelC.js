function drawParallelC(file1Data, file2Data, file3Data, file4Data) {
    ...
    PEA4 = PEA4 / 5;
    const data = [
        { letter: 'GodawariPower', Price_to_Earnings_ratio: PEA1, Price_to_Sales_ratio: SalesA1, EPS: EPSA1 },
        { letter: 'ImpexFerroTech', Price_to_Earnings_ratio: PEA2, Price_to_Sales_ratio: SalesA2, EPS: EPSA2 },
        { letter: 'PrecisionWires', Price_to_Earnings_ratio: PEA3, Price_to_Sales_ratio: SalesA3, EPS: EPSA3 },
        { letter: 'TechnocraftInd', Price_to_Earnings_ratioe: PEA4, Price_to_Sales_ratio: SalesA4, EPS: EPSA4 }
    ];
    ...
    const yScale = d3.scaleLinear()
        .domain([0,
            Math.max(EPSA1, EPSA2, EPSA3, EPSA4, SalesA1, SalesA2, SalesA3, SalesA4, PEA1, PEA2, PEA3, PEA4) + 10])
        .range([height - 50, 0]);
    ...
    const GodawariPower = svg.selectAll(".GodawariPower-dot")
        ...
        .on("mouseover", function (event, d) {
            ...
            showTooltip(event, `GodawariPower: ${d.value}`);
        })
    ...
    const ImpexFerroTech = svg.selectAll(".ImpexFerroTech-dot")
        ...
        .on("mouseover", function (event, d) {
            // Show tooltip on mouseover
            showTooltip(event, `ImpexFerrotech: ${d.value}`);
        })
        .on("mouseout", function () {
            // Hide tooltip on mouseout
            hideTooltip();
    ...
    const PrecisionWires = svg.selectAll(".PrecisionWires-dot")
        ...
        .on("mouseover", function (event, d) {
            // Show tooltip on mouseover
            showTooltip(event, `PrecisionWires: ${d.value}`);
        })
        .on("mouseout", function () {
            // Hide tooltip on mouseout
            hideTooltip();
    ...
    const TechnocraftInd = svg.selectAll(".TechnocraftInd-dot")
        ...
        .on("mouseover", function (event, d) {
            // Show tooltip on mouseover
            showTooltip(event, `Technocraft: ${d.value}`);
        })
        .on("mouseout", function () {
            // Hide tooltip on mouseout
            hideTooltip();
    ...
    const lineGodawariPower12 = svg.append("line")
        .attr("class", "lineGodawariPower12")
    ...
    const lineGodawariPower23 = svg.append("line")
        .attr("class", "lineGodawariPower23")
        ...
        .attr("stroke-width", 2)
        .attr("opacity", 0.8);
    const lineImpexFerroTech12 = svg.append("line")
        .attr("class", "lineImpexFerroTech12")
        .attr("x1", xScale("Price_to_Earnings_ratio")) // Start x-coordinate
    ...
    const lineImpexFerroTech23 = svg.append("line")
        .attr("class", "lineImpexFerroTech23")
        .attr("x1", xScale("Price_to_Sales_ratio")) // Start x-coordinate
    ...
    const linePrecisionWires12 = svg.append("line")
        .attr("class", "linePrecisionWires12")
        .attr("x1", xScale("Price_to_Earnings_ratio")) // Start x-coordinate
    ...
    const linePrecisionWires23 = svg.append("line")
        .attr("class", "linePrecisionWires23")
        .attr("x1", xScale("Price_to_Sales_ratio")) // Start x-coordinate
    ...
    const lineTechnocraftInd12 = svg.append("line")
        .attr("class", "lineTechnocraftInd12")
        .attr("x1", xScale("Price_to_Earnings_ratio")) // Start x-coordinate
    ...
    const lineTechnocraftInd23 = svg.append("line")
        .attr("class", "lineTechnocraftInd23")
        .attr("x1", xScale("Price_to_Sales_ratio")) // Start x-coordinate
    ...
    const legendItems = legend.selectAll(".legend-item")
        .data(["GodawariPower", "ImpexFerroTech", "PrecisionWires", "Technocraft"])
        .enter().append("g")
    ...
    legendItems.append("rect")
        ...
        .attr("fill", d => {
            switch (d) {
                case "GodawariPower": return "blue";
                case "ImpexFerroTech": return "green";
                case "PrecisionWires": return "purple";
                case "Technocraft": return "red";
